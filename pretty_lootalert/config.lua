...
private.config = {
    ...
    point_x        = -360,     -- position of toast by X
    point_y        = 200,      -- position of toast by Y
    ...
    low_level      = 0,         -- what item quality will be prioritized at low level (e.g. not less than 2 [uncommon])
    max_level      = 0,         -- what item quality will be prioritized at 80 level (e.g. not less than 4 [epic])
    --[[
        req. ignore_level = false
        [0] = poor, [1] = common, [2] = uncommon, [3] = rare, [4] = epic, [5] = legendary, [6] = artifact, [7] = heirloom
    ]]
    
    filter         = true,      -- filtering for certain items by type
